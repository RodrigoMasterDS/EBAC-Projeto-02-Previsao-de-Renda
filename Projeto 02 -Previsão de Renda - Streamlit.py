...
(www.linkedin.com/in/rodrigodatascience/)<br>
...
st.markdown('# <div style="text-align:center"> [Previsão de renda](https://github.com/RodrigoMasterDS/EBAC-Projeto-02-Previsao-de-Renda) </div>',
            unsafe_allow_html=True)
